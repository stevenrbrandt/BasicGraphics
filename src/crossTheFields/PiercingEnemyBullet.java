 ...
 * @author theha
 */
public class PiercingEnemyBullet extends Sprite {
    
    PiercingEnemyBullet(SpriteComponent sc, double startX, double startY, Soldier soldier) {
        super(sc);
        setPicture(Main.makeBall(Color.ORANGE, 4));
        setX(startX+10);
        setY(startY+10);
